...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/shibadai/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/shibadai/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/shibadai/db"
...
func (s *Server) Init(dbconf, env string) error {
  ...
  //
	// tutorial. 自己紹介を追加する
	// ...
	s.Engine.GET("/shibadai", func(c *gin.Context) {
		c.HTML(http.StatusOK, "shibadai.html", gin.H{})
	})
