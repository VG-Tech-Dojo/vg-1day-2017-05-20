...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/haruka/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/haruka/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/haruka/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/haruka", func(c *gin.Context) {
		 c.HTML(http.StatusOK, "haruka.html", gin.H{})
})// tutorial. 自己紹介を追加する
	// ...
