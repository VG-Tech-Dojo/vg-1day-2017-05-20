...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/makki/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/makki/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/makki/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/makki", func(c *gin.Context) {
		c.HTML(http.StatusOK, "makki.html", gin.H{})
	})
