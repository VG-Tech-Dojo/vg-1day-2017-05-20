...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/team3/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/team3/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/team3/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	wordEmotionBot := bot.NewWordEmotionBot(s.poster.In)
	s.bots = append(s.bots, wordEmotionBot)
