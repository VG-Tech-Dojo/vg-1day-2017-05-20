...
import (
	...
	"fmt"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/fono09/env"
...
func (p *NewGachaProcessor) Process(msgIn *model.Message) *model.Message {
	results := []string{
		"SSレア",
		"Sレア",
		"レア",
	...
	result := results[randIntn(len(results))]
	return &model.Message {
		Body: result,
	}
}
