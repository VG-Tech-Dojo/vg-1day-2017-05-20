...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/fono09/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/fono09/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/fono09/db"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/fono09/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/fono09", func(c *gin.Context){
		c.HTML(http.StatusOK, "fono09.html", gin.H{})
