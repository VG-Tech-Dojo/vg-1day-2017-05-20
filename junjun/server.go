...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/junjun/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/junjun/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/junjun/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/junjun", func(c *gin.Context) {
		c.HTML(http.StatusOK, "junjun.html", gin.H{})
	})
