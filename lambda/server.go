...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/lambda/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/lambda/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/lambda/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/lambda", func(c *gin.Context) {
		c.HTML(http.StatusOK, "lambda.html", gin.H{})
	})
