...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/jin/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/jin/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/jin/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/jin", func(c *gin.Context) {
		c.HTML(http.StatusOK, "jin.html", gin.H{})
	})
