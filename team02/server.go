...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/team02/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/team02/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/team02/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	homeBot := bot.NewHomeBot(s.poster.In)
	s.bots = append(s.bots, homeBot)
