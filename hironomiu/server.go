...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/hironomiu/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/hironomiu/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/hironomiu/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/hironomiu", func(c *gin.Context) {
		c.HTML(http.StatusOK, "hironomiu.html", gin.H{})
	})
