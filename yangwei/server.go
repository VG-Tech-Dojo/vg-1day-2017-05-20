...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017/yangwei/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017/yangwei/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017/yangwei/db"
...
func (s *Server) Init(dbconf, env string) error {
  ...
  s.Engine.GET("/yangwei", func(c *gin.Context) {
    c.HTML(http.StatusOK, "yangwei.html", gin.H{})
  })
