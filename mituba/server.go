...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/mituba/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/mituba/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/mituba/db"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/mituba/model"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/mituba", func(c *gin.Context) {
		c.HTML(http.StatusOK, "mituba.html", gin.H{})
	})
	...
	gatyaBot := bot.NewGatyaBot(s.poster.In)
	s.bots = append(s.bots, gatyaBot)
