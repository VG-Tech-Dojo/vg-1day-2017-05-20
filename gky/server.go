...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/gky/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/gky/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2017-05-20/gky/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	// tutorial. 自己紹介を追加する
	s.Engine.GET("/gky", func(c *gin.Context) {
		c.HTML(http.StatusOK, "gky.html", gin.H{})
	})
